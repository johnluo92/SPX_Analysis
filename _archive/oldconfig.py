...
COMMODITY_FRED_SERIES = {
    ...
    'DHHNGSP': 'Natural Gas',
    # 'PPIACO': 'Producer_Price_Index' # monthly data deprecated/removed, because by mixing frequencies, system creates autocorrelation artifacts that poison statistical assumptions
}
...
# Legacy thresholds - DEPRECATED, use detector.statistical_thresholds instead
# LEGACY_ANOMALY_THRESHOLDS = {'moderate': 0.70, 'high': 0.78, 'critical': 0.88}
