...
FEATURE_SELECTION_CONFIG={'expansion_top_n':76,'compression_top_n':91,'up_top_n':90,'down_top_n':80,'cv_folds':5,'protected_features':[],'correlation_threshold':0.9585,'description':'Unified tuning with ensemble evaluation'}
...
UP_CLASSIFIER_PARAMS={'objective':'binary:logistic','eval_metric':'aucpr','max_depth':4,'learning_rate':0.0380,'n_estimators':280,'subsample':0.68,'colsample_bytree':0.85,'min_child_weight':10,'reg_alpha':10.0,'reg_lambda':20.0,'gamma':2.4,'scale_pos_weight':0.95,'early_stopping_rounds':50,'seed':42,'n_jobs':1,'random_state':42}

DOWN_CLASSIFIER_PARAMS={'objective':'binary:logistic','eval_metric':'logloss','max_depth':4,'learning_rate':0.0340,'n_estimators':400,'subsample':0.66,'colsample_bytree':0.66,'min_child_weight':20,'reg_alpha':13.0,'reg_lambda':20.0,'gamma':2.8,'scale_pos_weight':0.68,'early_stopping_rounds':50,'seed':42,'n_jobs':1,'random_state':42}

ENSEMBLE_CONFIG={'enabled':True,'reconciliation_method':'winner_takes_all','up_advantage':0.09,'confidence_weights':{'up':{'classifier':0.65,'magnitude':0.35},'down':{'classifier':0.65,'magnitude':0.35}},'magnitude_scaling':{'up':{'small':4.0,'medium':8.0,'large':12.0},'down':{'small':4.0,'medium':8.0,'large':12.0}},'dynamic_thresholds':{'up':{'high_magnitude':0.76,'medium_magnitude':0.80,'low_magnitude':0.84},'down':{'high_magnitude':0.78,'medium_magnitude':0.82,'low_magnitude':0.86}},'min_confidence_up':0.76,'min_confidence_down':0.78,'boost_threshold_up':15.0,'boost_threshold_down':15.0,'boost_amount_up':0.06,'boost_amount_down':0.06,'description':'High threshold ensemble to filter weak signals'}
