...
ENSEMBLE_CONFIG={'enabled':True,'reconciliation_method':'winner_takes_all','up_advantage':0.0913,'confidence_weights':{'up':{'classifier':0.6453,'magnitude':0.3547},'down':{'classifier':0.5411,'magnitude':0.4589}},'magnitude_scaling':{'up':{'small':2.7955,'medium':5.0043,'large':10.3435},'down':{'small':3.4702,'medium':4.6143,'large':8.9073}},'dynamic_thresholds':{'up':{'high_magnitude':0.5981,'medium_magnitude':0.6780,'low_magnitude':0.6992},'down':{'high_magnitude':0.7843,'medium_magnitude':0.8044,'low_magnitude':0.8333}},'min_confidence_up':0.5625,'min_confidence_down':0.6675,'boost_threshold_up':10.4039,'boost_threshold_down':12.6627,'boost_amount_up':0.0791,'boost_amount_down':0.0520,'description':'Phase 2 optimized for 70%+ balanced accuracy'}
