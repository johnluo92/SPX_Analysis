...
FEATURE_SELECTION_CV_PARAMS={'n_estimators':105,'max_depth':6,'learning_rate':0.0639,'subsample':0.8266,'colsample_bytree':0.7005,'n_jobs':1,'random_state':42}
...
EXPANSION_PARAMS={'objective':'reg:squarederror','eval_metric':'rmse','max_depth':4,'learning_rate':0.0114,'n_estimators':603,'subsample':0.7603,'colsample_bytree':0.9497,'colsample_bylevel':0.8720,'min_child_weight':13,'reg_alpha':3.0552,'reg_lambda':7.9579,'gamma':0.0218,'early_stopping_rounds':50,'seed':42,'n_jobs':1,'random_state':42}
COMPRESSION_PARAMS={'objective':'reg:squarederror','eval_metric':'rmse','max_depth':3,'learning_rate':0.0846,'n_estimators':541,'subsample':0.7664,'colsample_bytree':0.7703,'colsample_bylevel':0.9295,'min_child_weight':11,'reg_alpha':7.0132,'reg_lambda':3.6590,'gamma':0.5431,'early_stopping_rounds':50,'seed':42,'n_jobs':1,'random_state':42}
UP_CLASSIFIER_PARAMS={'objective':'binary:logistic','eval_metric':'aucpr','max_depth':6,'learning_rate':0.1111,'n_estimators':776,'subsample':0.7562,'colsample_bytree':0.9223,'min_child_weight':13,'reg_alpha':4.8640,'reg_lambda':9.2011,'gamma':0.5018,'scale_pos_weight':1.0,'early_stopping_rounds':50,'seed':42,'n_jobs':1,'random_state':42}
DOWN_CLASSIFIER_PARAMS={'objective':'binary:logistic','eval_metric':'aucpr','max_depth':8,'learning_rate':0.0883,'n_estimators':766,'subsample':0.7406,'colsample_bytree':0.8341,'min_child_weight':11,'reg_alpha':2.6657,'reg_lambda':7.8673,'gamma':0.1054,'scale_pos_weight':1.0,'early_stopping_rounds':50,'seed':42,'n_jobs':1,'random_state':42}
