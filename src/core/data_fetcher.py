...
class UnifiedDataFetcher:
    ...
    WEEKLY_SERIES={"ICSA","STLFSI4","WALCL","WTREGEN"}
    ...
    CBOE_FILES={"VXTH":"VXTH_TAILHEDGE_CBOE.csv","CL1-CL2":"CL1-CL2.csv","VXTLT":"VXTLT.csv"}
    ...
    def fetch_yahoo(self,symbol,start_date=None,end_date=None,incremental=True):
        ...
        if is_historical_request and cache_path.exists():
            ...
            except Exception as e:self.logger.debug(f"Yahoo:{symbol}: Cache read failed - {e}")
