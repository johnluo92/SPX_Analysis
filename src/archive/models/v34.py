"""
Sector Rotation Model v3.4 - Stability & Diversity Boost
IMPROVEMENTS over v3.3:
- ✅ Extended to 10 years of data (52% more samples)
- ✅ Sector-specific hyperparameters (adaptive complexity)
- ✅ Enhanced feature engineering (interaction terms)
- ✅ Probability calibration (isotonic regression)
- ✅ Target: 7+ sectors with gap <0.25
"""
...
class SectorRotationFeaturesV4:
    """Feature engineering v3.4 - interaction terms."""
    ...
    def calculate_macro_changes(self,
        ...
        """Calculate macro changes with interaction terms."""
        ...
        # NEW: Interaction terms (key relationships)
    ...
    def combine_features(self,
        ...
        print("\n" + "="*70)
        print("FEATURE ENGINEERING v3.4 - INTERACTIONS")
        print("="*70)
...
class SectorRotationModelV4:
    """Model v3.4 - sector-specific hyperparameters."""
    
    def __init__(self, random_state: int = 42):
        """Initialize with adaptive hyperparameters."""
        ...
        # Sector-specific adjustments (for problem children)
        self.sector_adjustments = {
            'XLU': {'min_samples_leaf': 50, 'max_depth': 5},  # More regularization
            'XLI': {'min_samples_leaf': 50, 'max_depth': 5},
            'XLY': {'min_samples_leaf': 45, 'max_depth': 5},
            'XLC': {'min_samples_leaf': 45, 'max_depth': 5},
        }
    ...
    def get_sector_config(self, ticker: str) -> Dict:
        ...
        if ticker in self.sector_adjustments:
            config.update(self.sector_adjustments[ticker])
        return config
    ...
    def analyze_feature_importance(self,
        ...
        """Feature selection with 1.2% threshold (slightly lower)."""
        print("\n" + "="*70)
    ...
    def train_models(self,
        ...
        """Train models with sector-specific config + calibration."""
        print("\n" + "="*70)
        print("TRAINING MODELS - ADAPTIVE & CALIBRATED")
        print("="*70)
    ...
    def predict_probabilities(self, features: pd.DataFrame, use_calibrated: bool = True) -> pd.DataFrame:
        """Predict rotation probabilities (calibrated)."""
        if self.selected_features is not None:
            features = features[self.selected_features]
...
def test_v34_model():
    """Test v3.4 - stability boost."""
    print("\n" + "="*70)
    print("SECTOR ROTATION MODEL v3.4 - STABILITY BOOST")
    print("="*70)
    ...
    print(f"📅 Data period: {start_str} to {end_str} (10 years)")
    print(f"   Rationale: 52% more samples vs 7 years")
    ...
    # Feature engineering
    print("\n📊 Step 2: Feature Engineering (v3.4)")
    print("-"*70)
    
    feat_eng = SectorRotationFeaturesV4()
    ...
    # Gap analysis
    print("\n" + "="*70)
    print("GAP THRESHOLD ANALYSIS (Target: 7+ <0.25)")
    print("="*70)
    ...
    print(f"   Goal: 7+ sectors ✅" if total_under_25 >= 7 else f"   Goal: 7+ sectors (current: {total_under_25})")
    ...
    print("="*70)
    print("\n🚀 v3.4 Improvements:")
    print("   ✅ 10 years of data (52% more samples)")
    print("   ✅ Sector-specific hyperparameters (XLU, XLI, XLY, XLC)")
    print("   ✅ Interaction terms (Slope×Credit, Energy×Metals)")
    print("   ✅ Probability calibration (isotonic regression)")
    print("   ✅ Lower feature threshold (1.2% vs 1.5%)")
    print("   🎯 Goal: 7+ sectors with gap <0.25\n")
