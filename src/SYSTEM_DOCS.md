...
*Generated: 2025-11-13 12:50:35*

## Overview
- Total modules analyzed: 18
- Total lines of code: 11098
...
**Functions:**
- `validate_feature_quality(features: pd.DataFrame, feature_list: list, detector_name: str) -> Tuple[<ast.Tuple object at 0x1036a5910>]`
...
- `get_feature_contributions(self, detector_name: str, top_n: int) -> List[Tuple[<ast.Tuple object at 0x1036c28d0>]]`
...
- `fetch_all_fred_series(self, start_date: str, end_date: str, ...) -> Dict[<ast.Tuple object at 0x10350d450>]`
...
- `FuturesFeatureEngine`
    - `extract_vix_futures_features(vx_data: Dict[<ast.Tuple object at 0x1034f6dd0>])`
    - `extract_commodity_futures_features(futures_data: Dict[<ast.Tuple object at 0x1034ccc50>])`
    - `extract_dollar_futures_features(dollar_data: Dict[<ast.Tuple object at 0x1034b7e10>])`
    - `extract_futures_cross_relationships(vx_data: Dict[<ast.Tuple object at 0x1036dfad0>], commodity_data: Dict[<ast.Tuple object at 0x1036df710>], dollar_data: Dict[<ast.Tuple object at 0x1036df350>], ...)`
...
- `extract_vix_futures_features(vx_data: Dict[<ast.Tuple object at 0x1034f6dd0>]) -> pd.DataFrame`
- `extract_commodity_futures_features(futures_data: Dict[<ast.Tuple object at 0x1034ccc50>]) -> pd.DataFrame`
- `extract_dollar_futures_features(dollar_data: Dict[<ast.Tuple object at 0x1034b7e10>]) -> pd.DataFrame`
- `extract_futures_cross_relationships(vx_data: Dict[<ast.Tuple object at 0x1036dfad0>], commodity_data: Dict[<ast.Tuple object at 0x1036df710>], dollar_data: Dict[<ast.Tuple object at 0x1036df350>], ...) -> pd.DataFrame`
...
#### `prediction_database.py` (726 lines)
...
- `TemporalSafetyValidator`
  - Comprehensive temporal safety validation with feature quality scoring.
    - `__init__(self, publication_lags: Dict[<ast.Tuple object at 0x1036d6c10>])`
...
- `verify_publication_lags(self, features: pd.DataFrame, prediction_date: datetime, ...) -> Tuple[<ast.Tuple object at 0x10354c410>]`
- `validate_walk_forward_gap(self, features: pd.DataFrame, prediction_date: datetime, ...) -> Tuple[<ast.Tuple object at 0x1034a19d0>]`
- `test_feature_availability_at_prediction_time(self, features: pd.DataFrame, feature_metadata: Dict[<ast.Tuple object at 0x1034a2410>], ...) -> Dict`
...
- `run_full_validation(feature_engine_path: str, publication_lags: Dict[<ast.Tuple object at 0x1036a9390>]) -> TemporalSafetyValidator`
...
- `FuturesFeatureEngine`
  - Specialized feature extraction for futures contracts.
    - `extract_vix_futures_features(vx_data: Dict[<ast.Tuple object at 0x103544490>])`
    - `extract_commodity_futures_features(futures_data: Dict[<ast.Tuple object at 0x1034c8810>])`
    - `extract_dollar_futures_features(dollar_data: Dict[<ast.Tuple object at 0x1034a0110>])`
    - `extract_futures_cross_relationships(vx_data: Dict[<ast.Tuple object at 0x10387fd10>], commodity_data: Dict[<ast.Tuple object at 0x10387fa10>], dollar_data: Dict[<ast.Tuple object at 0x10387e490>], ...)`
- `UnifiedFeatureEngine`
...
- `extract_rate_of_change_features(df: pd.DataFrame) -> pd.DataFrame`
- `extract_percentile_rankings(df: pd.DataFrame) -> pd.DataFrame`
- `extract_vix_futures_features(vx_data: Dict[<ast.Tuple object at 0x103544490>]) -> pd.DataFrame`
- `extract_commodity_futures_features(futures_data: Dict[<ast.Tuple object at 0x1034c8810>]) -> pd.DataFrame`
- `extract_dollar_futures_features(dollar_data: Dict[<ast.Tuple object at 0x1034a0110>]) -> pd.DataFrame`
- `extract_futures_cross_relationships(vx_data: Dict[<ast.Tuple object at 0x10387fd10>], commodity_data: Dict[<ast.Tuple object at 0x10387fa10>], dollar_data: Dict[<ast.Tuple object at 0x10387e490>], ...) -> pd.DataFrame`
...
#### `integrated_system_production.py` (1237 lines)
...
- `feature_quality_diagnostic.py` → core.feature_engine, core.data_fetcher
- `forecast_calibrator.py` → core.prediction_database
- `integrated_system_production.py` → core.forecast_calibrator, core.xgboost_feature_selector_v2, core.data_fetcher, core.feature_engine, diagnostics.walk_forward_validation, core.temporal_validator, core.prediction_database, core.anomaly_detector, core.xgboost_trainer_v2
- `prediction_database.py` → core.data_fetcher
- `train_probabilistic_models.py` → core.feature_engine, core.data_fetcher, core.xgboost_trainer_v2